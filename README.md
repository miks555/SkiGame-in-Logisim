...
A simple downhill ski game implemented entirely in [Logisim](https://www.cburch.com/logisim/), using only digital logic components such as logic gates, flip-flops, counters, and multiplexers.
